...
<script>
	function validate() {
		...
		if (uid == "") {
			...
			result = false;
			$("#errorUid").html("최대 15자까지만 입력해야 합니다.");
		}
		...
		if (result == true) {
			$("#joinForm")[0].submit();	//id를 통해서 접근
			//document.joinForm.submit();	//name을 통해서 접근
		}
	}
</script>
...
<div>
	...
	<form id="joinForm" name="joinForm" method="post" action="join" onsubmit="validate()" novalidate="novalidate">
